...
public class ItemLiquidContainer extends Item {
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int x, int y, int z, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
		   //todo: travnik fix
		   if(p_77648_2_ != null && EventUtils.cantBreak(p_77648_2_, x, y, z)){
			   return true;
		   }
		   return super.onItemUse(p_77648_1_, p_77648_2_, p_77648_3_, x, y, z, p_77648_7_, p_77648_8_, p_77648_9_, p_77648_10_);
	}
}
